# The name of this view in Looker is "Scheduled Plan"
view: scheduled_plan {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: gcpl248.scheduled_plan ;;
  drill_fields: [id]
  ...
  dimension_group: created {
    ...
    # This dimension will be called "Crontab" in Explore.
  ...
  measure: total_next_run_at {
    type: sum
    sql: ${next_run_at} ;;  }
  measure: average_next_run_at {
    type: average
    sql: ${next_run_at} ;;  }
