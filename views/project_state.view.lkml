# The name of this view in Looker is "Project State"
view: project_state {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: gcpl248.project_state ;;
  drill_fields: [id]
  ...
  dimension: id {
    ...
    # This dimension will be called "All Unit Tests" in Explore.
  ...
  measure: total_invalid_at {
    type: sum
    sql: ${invalid_at} ;;  }
  measure: average_invalid_at {
    type: average
    sql: ${invalid_at} ;;  }
