# The name of this view in Looker is "Credentials Ephemeral"
view: credentials_ephemeral {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: gcpl248.credentials_ephemeral ;;
  drill_fields: [id]
  ...
  dimension_group: expires {
    ...
    # This dimension will be called "Login Used" in Explore.
