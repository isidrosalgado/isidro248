# The name of this view in Looker is "Ldap User Attribute Attribute"
view: ldap_user_attribute_attribute {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: gcpl248.ldap_user_attribute_attribute ;;
  drill_fields: [id]
  ...
  dimension: id {
    ...
    # This dimension will be called "Ldap User Attribute ID" in Explore.
